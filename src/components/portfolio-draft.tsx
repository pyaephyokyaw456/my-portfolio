...
function Preloader({ onComplete }: { onComplete: () => void }) {
  ...
  useEffect(() => {
    // Lock scroll to prevent background scrolling during load
    ...
    .to(textRef.current, { scale: 1.05, duration: 0.6, ease: "sine.inOut" })
  ...
  return (
    <div ref={containerRef} className="fixed inset-0 z-[10000] bg-[#09090b] flex flex-col items-center justify-center will-change-transform">
       <div ref={textRef} className="text-6xl md:text-8xl font-black tracking-tighter text-white flex items-baseline">
      ...
      */}
      ...
      <div className="mx-auto max-w-[1400px] px-6 py-6 sm:px-10 lg:px-16">
        ...
        <main className="relative z-10 pt-20 lg:pt-32 lg:pl-20">
          ...
          {/* ── HERO ── */}
          <section className="pb-24 lg:pb-40 overflow-hidden flex flex-col lg:flex-row lg:items-center gap-12 lg:gap-0 mt-8 mb-8" id="hero">
            {/* Left Side: Text and CTA */}
            <div className="flex-1 max-w-[55rem] lg:max-w-[50%] lg:pr-8 order-2 lg:order-1 pt-8 lg:pt-0">
            ...
            <div className="flex-1 hero-support flex justify-center lg:justify-end relative order-1 lg:order-2 mb-8 lg:mb-0">
               <div className="relative w-full max-w-[360px] md:max-w-[450px] lg:max-w-[550px] z-10 mx-auto drop-shadow-[0_10px_40px_rgba(0,0,0,0.15)] flex justify-center items-center overflow-hidden lg:overflow-visible">
                  {siteData.hero.image && (
